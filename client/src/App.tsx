      ...
      <div className="relative z-10 flex flex-col gap-20 px-6 py-20 md:px-10 lg:px-24">
        ...
        <div className="max-w-4xl space-y-8">
          ...
          <p className="max-w-2xl text-lg font-medium leading-relaxed text-muted2 md:text-xl">
            Build your profile, share your story, and connect with the people
            who move your work forward. A minimalist network for high-signal
            thinkers.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-4">
            <Button
              asChild
              className="h-14 rounded-2xl bg-lu-accent px-8 text-base font-bold text-white shadow-lg shadow-lu-accent/20 transition-all hover:bg-lu-accent/90 hover:scale-[1.02] active:scale-[0.98]"
            >
            ...
            <div className="flex items-center gap-2 ml-2">
              <div className="flex -space-x-2">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="h-8 w-8 rounded-full border-2 border-void bg-muted2"
                  />
                ))}
              </div>
          ...
          {[
            ...
            >
              ...
              <div className="relative z-10 space-y-4">
                ...
                <div>
                  <p
                    className={`text-[10px] font-black uppercase tracking-[0.3em] ${feature.color}`}
                  >
                    Feature 0{index + 1}
                  </p>
